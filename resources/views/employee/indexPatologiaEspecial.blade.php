...
<div class="container">
    ...
    <table id="PatologiaEspecialDatatable" class="table table-dark">
    ...
    <script>
        $(function() {
            $('#PatologiaEspecialDatatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!!  route('employeesDataTablePatologiaEspecial') !!}',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
