                    ...
                    <div class="row">
                        ...
                        <div class="col s6">
                            ...
                            <input type="text" class="form-control" placeholder="numero de telefono"
                                name="numero_telefono" value="{{ $data->numero_telefono }}">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s6">
                            ...
                            <select class="form-control" name="seccion_id">
                                ...
                                <option value="{{ $seccion->id }}" {{ $seccion->id == $data->seccion_id ? 'selected' : '' }}>{{ $seccion->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s6">
                            ...
                            <input type="text" class="form-control" placeholder="alergias de medicamento"
                                name="alergias_medicamento" value="{{ $data->alergias_medicamento }}">
                        </div>
                        ...
                        <div class="col s6">
                            ...
                            <input type="text" class="form-control" placeholder="telefono de emergencia"
                                name="telefono_emergencia" value="{{ $data->telefono_emergencia }}">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s6">
                            ...
                            <input type="text" class="form-control" placeholder="enfermedad laboral"
                                name="enfermedad_laboral" value="{{ $data->enfermedad_laboral }}">
                        </div>
                        ...
                        <div class="col s6">
                            ...
                            <input type="text" class="form-control" placeholder="accidentes de trabajo"
                                name="accidentes_trabajo" value="{{ $data->accidentes_trabajo }}">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s6">
                            ...
                            <input type="text" class="form-control" placeholder="enfermedad comun"
                                name="enfermedad_comun" value="{{ $data->enfermedad_comun }}">
                        </div>
